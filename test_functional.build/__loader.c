 ...
 */
extern PyObject *modulecode_test_functional(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"test_functional", modulecode_test_functional, 0, 0, NUITKA_TRANSLATED_FLAG
